...
tf.app.flags.DEFINE_integer("enc_vocab_size", 40000, "English vocabulary size.")
tf.app.flags.DEFINE_integer("dec_vocab_size", 40000, "French vocabulary size.")
# tf.app.flags.DEFINE_string("data_dir", "/tmp", "Data directory")
tf.app.flags.DEFINE_string("working_directory", "/tmp", "Training directory.")
tf.app.flags.DEFINE_string("train_enc", None, "Training data.")
tf.app.flags.DEFINE_string("train_dec", None, "Training data.")
tf.app.flags.DEFINE_string("test_enc", None, "Training data.")
tf.app.flags.DEFINE_string("test_dec", None, "Training data.")
...
tf.app.flags.DEFINE_string("mode", None, "Executing mode.")
...
def create_model(session, forward_only):
  ...
  #     model.saver.restore(session,FLAGS.pretrained_model)
  #     return model
...
def train():
  # prepare dataset
  print("Preparing data in %s" % FLAGS.working_directory)
  enc_train, dec_train, enc_dev, dec_dev, _, _ = data_utils.prepare_data(
    FLAGS.working_directory,FLAGS.train_enc,FLAGS.train_dec,FLAGS.test_enc,FLAGS.test_dec,FLAGS.enc_vocab_size,FLAGS.dec_vocab_size)
...
if __name__ == '__main__':
    ...
    print('\n>> Mode : %s\n' %(FLAGS.mode))
    print(FLAGS.buckets)
    print(FLAGS.train_enc)
    print(FLAGS.train_dec)
    print(FLAGS.test_enc)
    print(FLAGS.test_dec)
    print(FLAGS.working_directory)
